...
local function generateScriptFormat(elementIndex)
    local generatedScript = [[-- Generated by Hydroxide's Upvalue Scanner: https://github.com/IHaxU/Hydroxide

local aux = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/IHaxU/Hydroxide/revision/ohaux.lua"))()
